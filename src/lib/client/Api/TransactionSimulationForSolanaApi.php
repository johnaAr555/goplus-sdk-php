...
class TransactionSimulationForSolanaApi
{
     ...
     */
    public function prerunTxUsingPOST($body)
    {
        list($response) = $this->prerunTxUsingPOSTWithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function prerunTxUsingPOSTWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\ResponseWrapperSolanaPrerunTxResponse';
        $request = $this->prerunTxUsingPOSTRequest($body);
     ...
     */
    public function prerunTxUsingPOSTAsync($body)
    {
        return $this->prerunTxUsingPOSTAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function prerunTxUsingPOSTAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\ResponseWrapperSolanaPrerunTxResponse';
        $request = $this->prerunTxUsingPOSTRequest($body);
     ...
     */
    protected function prerunTxUsingPOSTRequest($body)
    {
