...
class TokenSecurityAPIForSolanaBetaApi
{
     ...
     */
    public function solanaTokenSecurityUsingGET($contract_addresses)
    {
        list($response) = $this->solanaTokenSecurityUsingGETWithHttpInfo($contract_addresses);
        return $response;
    }
     ...
     */
    public function solanaTokenSecurityUsingGETWithHttpInfo($contract_addresses)
    {
        $returnType = '\Swagger\Client\Model\ResponseWrapperSolanaTokenSecurity';
        $request = $this->solanaTokenSecurityUsingGETRequest($contract_addresses);
     ...
     */
    public function solanaTokenSecurityUsingGETAsync($contract_addresses)
    {
        return $this->solanaTokenSecurityUsingGETAsyncWithHttpInfo($contract_addresses)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solanaTokenSecurityUsingGETAsyncWithHttpInfo($contract_addresses)
    {
        $returnType = '\Swagger\Client\Model\ResponseWrapperSolanaTokenSecurity';
        $request = $this->solanaTokenSecurityUsingGETRequest($contract_addresses);
     ...
     */
    protected function solanaTokenSecurityUsingGETRequest($contract_addresses)
    {
