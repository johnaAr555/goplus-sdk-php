...
class TokenSecurityAPIForSuiApi
{
     ...
     *
     * @param  string $contract_addresses contract_addresses (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ResponseWrapperSuiTokenSecurity
     */
    public function suiTokenSecurityUsingGET($contract_addresses = null)
    {
        list($response) = $this->suiTokenSecurityUsingGETWithHttpInfo($contract_addresses);
        return $response;
    }
     ...
     */
    public function suiTokenSecurityUsingGETWithHttpInfo($contract_addresses = null)
    {
        $returnType = '\Swagger\Client\Model\ResponseWrapperSuiTokenSecurity';
        $request = $this->suiTokenSecurityUsingGETRequest($contract_addresses);
     ...
     */
    public function suiTokenSecurityUsingGETAsync($contract_addresses = null)
    {
        return $this->suiTokenSecurityUsingGETAsyncWithHttpInfo($contract_addresses)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function suiTokenSecurityUsingGETAsyncWithHttpInfo($contract_addresses = null)
    {
        $returnType = '\Swagger\Client\Model\ResponseWrapperSuiTokenSecurity';
        $request = $this->suiTokenSecurityUsingGETRequest($contract_addresses);
     ...
     */
    protected function suiTokenSecurityUsingGETRequest($contract_addresses = null)
    {
